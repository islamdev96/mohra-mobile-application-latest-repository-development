...
class PersonalityDetailsScreen extends StatefulWidget {
  ...
  const PersonalityDetailsScreen({Key? key, required this.params})
      : super(key: key);
          ...
          child: Scaffold(
            ...
            body: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: AppConfig().appLanguage == AppConstants.LANG_EN
                      ? buildAppbarTitle(
                          "${UserSessionDataModel.name} ${isArabic ? "شخصيتك" : "Your Personality"}")
                      : buildAppbarTitle(
