...
class VisitUserPersonalityPageScreenContent extends StatelessWidget {
  final String? name;

  late VisitUserPersonalityPageScreenNotifier sn;
...
''';
  ...
  VisitUserPersonalityPageScreenContent({Key? key, this.name})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    sn = Provider.of<VisitUserPersonalityPageScreenNotifier>(context);
    sn.context = context;
