...
class DailyDishListView extends StatelessWidget {
  final double itemHeight;
  final String title;
  final String? icon;
  final List<DailyDishEntity> items;
  ...
  Widget _buildHealthItemCard(int index) {
    ...
    return HealthItemCard(
      height: itemHeight,
      name: item.recipeId == null? '${item.dishName}' : '${item.recipeName}',
      description: '${item.amountOfCalories}',
      image:item.recipeId == null? '${item.dishImage}' : '${item.recipeImage}',
