...
class _AddBreakfastBottomSheetState extends State<AddBreakfastBottomSheet> {
                        ...
                        BlocConsumer<HealthCubit, HealthState>(
                          ...
                          listener: (context, state) {
                            if (state is RecommendedFoodLoaded) {
                              widget.sn.onRecommendedFoodLoaded(
                                  state.recommendedFoodIListEntity);
                            }
                            if (state is DailyDishCreated) {
                              widget.sn.onDailyDisheat();
                            }
                          },
                              ...
                              const ScreenNotImplementedError(),
                                ...
                                dailyDishCreated: (s) =>
                                    _buildRecommendationCard(
                                        widget.sn.recommendedFoodItemEntity),
  ...
  Column _buildRecommendationCard(
      RecommendedFoodItemEntity recommendedFoodItemEntity) {
    return Column(
      children: [
        CustomListTile(
          ...
          leading: ClipRRect(
            ...
            child: Container(
              ...
              child: CachedNetworkImage(
                imageUrl: recommendedFoodItemEntity.imageUrl,
                fit: BoxFit.cover,
              ),
            ),
          ),
          title: Padding(
            ...
            child: Text(
              recommendedFoodItemEntity.name,
              style: TextStyle(
                color: Colors.black,
                fontSize: 37.sp,
                fontWeight: FontWeight.bold,
          ...
          subtitle: Padding(
            ...
            child: Text(
              '${recommendedFoodItemEntity.amountOfCalories} Kcal',
              style: TextStyle(
