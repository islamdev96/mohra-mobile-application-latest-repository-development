...
class HomeCommentsSecationScreenContent extends StatefulWidget {
  @override
  State<HomeCommentsSecationScreenContent> createState() =>
      _HomeCommentsSecationScreenContentState();
}

class _HomeCommentsSecationScreenContentState
    extends State<HomeCommentsSecationScreenContent> {
  late HomeCommentsSecationScreenNotifier sn;

  @override
  Widget build(BuildContext context) {
    sn = Provider.of<HomeCommentsSecationScreenNotifier>(context);
    sn.context = context;
    return Padding(
