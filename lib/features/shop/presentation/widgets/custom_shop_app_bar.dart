...
class ShopSearchTextField extends StatefulWidget {
  ...
  @override
  _ShopSearchTextFieldState createState() => _ShopSearchTextFieldState();
}

class _ShopSearchTextFieldState extends State<ShopSearchTextField> {
  @override
