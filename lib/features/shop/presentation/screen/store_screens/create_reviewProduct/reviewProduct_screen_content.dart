...
class CreateReviewProductScreenContent extends StatefulWidget {
  @override
  State<CreateReviewProductScreenContent> createState() =>
      _CreateReviewProductScreenContentState();
}

class _CreateReviewProductScreenContentState
    extends State<CreateReviewProductScreenContent> {
  ...
  Widget build(BuildContext context) {
    sn = Provider.of<ReviewProductScreenNotifier>(context);
            ...
            children: [
              Column(
                children: [
                  ...
                  Gaps.vGap32,
                  Text(Translation.of(context).rating_of_this_product),
                  Gaps.vGap32,
                  RatingBar.builder(
                    initialRating: sn.rate.toDouble(),
                    minRating: 1,
                      ...
                      listener: (context, state) {
                        state.mapOrNull(
                            ...
                            reviewProductLodedState: (s) {
                              ...
                              showSnackbar(Translation.current.create_review_success);
                            });
                      },
                      bloc: sn.storCubit,
