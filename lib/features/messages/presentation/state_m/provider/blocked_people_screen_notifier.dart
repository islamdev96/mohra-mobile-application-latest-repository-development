...
class BlockedPeopleScreenNotifier extends ScreenNotifier {
  /// Fields
  ...
  GetMyFriendsRequest getClientParams(int unit) {
    return GetMyFriendsRequest(skipCount: unit * 10, isBlock: true);
  }
  ...
  void onUnBlockMemberSuccess(FriendEntity unBlockedFriend) {
    print("called");
    clients
        .removeWhere((element) => element.friendId == unBlockedFriend.friendId);
    notifyListeners();
  }
}
