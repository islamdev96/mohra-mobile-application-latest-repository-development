...
class EventSelectTicketWidget extends StatefulWidget {
  ...
  @override
  State<EventSelectTicketWidget> createState() =>
      _EventSelectTicketWidgetState();
}

class _EventSelectTicketWidgetState extends State<EventSelectTicketWidget> {
  @override
  void initState() {
        ...
        children: ((widget.eventEntity.eventType == 0) ||
            ...
            ? [
                EventTicketWidget(
                  ...
                  availableSeats: widget.eventEntity.availableSeats!,
                  onQuantityChange: (p0) {
                    if (p0 > 0)
