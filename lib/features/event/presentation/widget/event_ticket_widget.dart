...
class _EventTicketWidgetState extends State<EventTicketWidget> {
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const Spacer(),
            if (!widget.disableSelection) _buildAddRemoveTicketWidget(),
          ],
        ));
  }
    ...
    return Row(
      children: [
        _buildAddRemoveButton(
            ...
            onTap: () {
              _editCount(-1, widget.availableSeats);
            }),
        SizedBox(
          width: 30.w,
        ),
  ...
  void _editCount(int addition, int available) {
    setState(() {
      if (addition == -1) {
