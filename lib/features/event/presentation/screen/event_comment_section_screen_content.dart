...
class EventCommentSectionScreenContent extends StatefulWidget {
  @override
  State<EventCommentSectionScreenContent> createState() =>
      _EventCommentSectionScreenContentState();
}

class _EventCommentSectionScreenContentState
    extends State<EventCommentSectionScreenContent> {
  late EventCommentSectionScreenNotifier sn;

  @override
  Widget build(BuildContext context) {
    sn = Provider.of<EventCommentSectionScreenNotifier>(context);
    sn.context = context;
    return Column(
            ...
            : GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style:
                        TextStyle(color: AppColors.textLight2, fontSize: 45.sp),
                  ),
                ),
              ),
        SizedBox(
