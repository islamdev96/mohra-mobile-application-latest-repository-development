...
@injectable
class GetClientsWithoutFriendsUseCase
    extends UseCase<ClientsEntity, GetClientsRequest> {
  final IFriendRepository repository;
  GetClientsWithoutFriendsUseCase(this.repository);
  @override
  Future<Result<AppErrors, ClientsEntity>> call(GetClientsRequest param) async {
    return await repository.getClientsWithoutFriends(param);
  }
}
