...
Future<void> openMap(double latitude, double longitude) async {
  ...
  await launchUrl(Uri.parse(googleUrl), mode: LaunchMode.externalApplication)
      .catchError((e) {
    toast('${language.invalidURL}: $googleUrl');
  });
}
...
List<LanguageDataModel> languageList() {
  return [
    LanguageDataModel(
        ...
        flag: 'booking_system_flutter/assets/flag/ic_us.png'),
    LanguageDataModel(
        id: 2,
        name: 'Hindi',
        languageCode: 'hi',
        fullLanguageCode: 'hi-IN',
        flag: 'booking_system_flutter/assets/flag/ic_india.png'),
    LanguageDataModel(
        id: 3,
        name: 'Arabic',
        languageCode: 'ar',
        fullLanguageCode: 'ar-AR',
        flag: 'booking_system_flutter/assets/flag/ic_ar.png'),
    LanguageDataModel(
        id: 4,
        name: 'French',
        languageCode: 'fr',
        fullLanguageCode: 'fr-FR',
        flag: 'booking_system_flutter/assets/flag/ic_fr.png'),
    LanguageDataModel(
        id: 5,
        name: 'German',
        languageCode: 'de',
        fullLanguageCode: 'de-DE',
        flag: 'booking_system_flutter/assets/flag/ic_de.png'),
  ];
}
